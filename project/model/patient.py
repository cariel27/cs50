...
from clinic_history import ClinicHistory
...
class Patient(Person):
    def __init__(self, **kwargs):
        ...
        if kwargs.get("clinic_history", False):
            self.clinic_history = kwargs["clinic_history"]
    ...
    @property
    def clinic_history(self) -> ClinicHistory:
        return self._clinic_history

    @clinic_history.setter
    def clinic_history(self, clinic_history: ClinicHistory):
        self._clinic_history = clinic_history
